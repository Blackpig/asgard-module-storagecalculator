<div class="box-body">
   <div class=col-md-4>
        {!! Form::normalInput('unit', trans('storagecalculator::discounts.form.unit'), $errors, $discounts) !!}
    </div>
    <div class=col-md-4>
        <label>&nbsp;</label>
    ...
    <div class=col-md-4>
        {!! Form::normalInput('amount', trans('storagecalculator::discounts.form.quantity_discount'), $errors, $discounts) !!}
    </div>
</div>
